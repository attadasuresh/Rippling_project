...
<div className='hr-card1 d-flex flex-row'>
      ...
      <input type="text" className='hr-inputbox' placeholder='   Enter Your Email Address'/><br/>
       ...
       <img className='hr-img1' src="images\Payroll.png"/>
       </div>
...
<p className='hr-para55'>Emp Concor brings all your IT systems and HR data together<br/>So you can easily manage everyone's IT—from onboarding to offboarding.
...
<Container>
      ...
      <div className='it-bg1'>
        <Col xs={6} md={4}>
          <Image  style={{height:"60px"}} src="images\10261140.png" rounded />
          <p className='it-p1'>Onboarding</p>
        </Col>
        <Col xs={6} md={4}>
          <Image className='it-img1' style={{height:"60px"}} src="images\EI-icon2048.webp" roundedCircle />
          <p className='it-p2'>Employee Changes</p>
        </Col>
        <Col xs={6} md={4}>
          <Image className='it-img1' style={{height:"60px"}} src="images\10261202__1_-removebg-preview.png" roundedCircle  />
...
<Col xs={6} md={4}>
          <Image  style={{height:"60px"}} src="images\main-menu-icon-in-flat-design-style-application-list-signs-illustration-png (1).webp" rounded />
          <p className='it-p11'>Apps</p>
        </Col>
        <Col xs={6} md={4}>
          <Image className='it-img1' style={{height:"60px"}} src="images\1864319.png" roundedCircle />
          <p className='it-p3'>Devices</p>
        </Col>
        <Col xs={6} md={4}>
          <Image className='it-img1' style={{height:"60px"}} src="images\pngtree-delivery-design-order-package-vector-picture-image_10448897.png" roundedCircle  />
...
<div className='it-bg10'>
  <img style={{height:"30px"}} src="images\25694.png"/>
...
<div className='it-bg11'>
  <img style={{height:"30px"}} src="images\40358.png"/>
...
<div className='it-bg11' >
  <img style={{height:"30px"}} src="images\icon-of-energy-thunder-lightning-bolt-symbol-or-electricity-power-electric-sign-symbol-free-png.webp"/>
...
<div className='it-bg11'>
  <img style={{height:"30px"}} src="images\Black Recycling Symbol (U+267B).png"/>
