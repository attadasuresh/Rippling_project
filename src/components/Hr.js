...
<Container>
      <Row>
        <Col xs={6} md={4}>
          <Image style={{height:"100px"}} src="images\10261140.png" rounded />
...
<div className='d-flex flex-row hr-bg10'>
  ...
  <img style={{height:"50px"}} src="images\dollar-bill-icon-in-flat-design-style-american-currency-signs-illustration-png.webp"/>
  ...
  <img style={{height:"50px"}} src="images\medical-drone-1945847-1645532.webp"/>
  ...
  images\pngtree-time-is-money-yellow-clock-icon-with-dollar-symbol-on-white-png-image_4952424.png"/>
