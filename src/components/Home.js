...
const Home = () => {
  return (
    <>
       ...
       <p className='para2'>Emp Concor lets you easily manage your employees’<br/> payroll, benefits, expenses, devices, apps & more—in one place.</p>
...
<div className='d-flex flex-row card9' >
    <img className='img5' src="images\pngtree-euro-business-finance-logo-icon-template-png-image_5453467.png"/>
...
<div className='d-flex flex-row card9' >
    <img className='img5' src="images\49117.png"/>
    <p style={{paddingLeft:"10px",fontWeight:"bold"}}>T & A</p>
</div>
<div className='d-flex flex-row card9' >
    <img className='img5' src="images\4415875.png"/>
...
<div className='d-flex flex-row card9' >
    <img className='img5' src="images\simple-people-icon-icon-of-grouping-of-people-png.webp"/>
    <p style={{paddingLeft:"10px",fontWeight:"bold"}}>Pulse</p>
</div>
<div className='d-flex flex-row card9' >
    <img className='img5' src="images\131-1318263_group-people-communication-message-talk-comments-people-management.png"/>
...
<div className='d-flex flex-row card91' >
    ...
    <img className='img5' src="images\814070.png"/>
...
<div className='d-flex flex-row card91' >
<img className='img5' src="images\monitoring-system-icon.webp"/>
...
<div className='d-flex flex-row card91' >
    <img className='img5' src="images\7888512.png"/>
...
<div className='d-flex flex-row card91' >
    <img className='img5' src="images\972601.png"/>
...
<div className='d-flex flex-row card92' >
    ...
    <img className='img10' src="images\pngtree-euro-business-finance-logo-icon-template-png-image_5453467.png"/>
...
<div>
    <img className='img11' src="images\globe-home.png"/>
</div>
...
<div className='card110'>
    <img style={{height:"60px"}} src="images\empConcorlogo.png"/>
